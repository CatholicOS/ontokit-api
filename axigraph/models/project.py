...
if TYPE_CHECKING:
    from axigraph.models.join_request import JoinRequest
    from axigraph.models.lint import LintRun
    from axigraph.models.normalization import NormalizationRun
    from axigraph.models.pull_request import GitHubIntegration, PullRequest

from axigraph.core.database import Base
